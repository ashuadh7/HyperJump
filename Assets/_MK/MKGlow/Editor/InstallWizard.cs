...
namespace MK.Glow.Editor.InstallWizard
{
    public sealed class InstallWizard : EditorWindow
    {
        ...
        private static void ShowWindow()
        {
            ...
            _window.maxSize = new Vector2(_scaledWidth, _scaledHeight);
            _window.Show();
        }
        ...
        private void OnGUI()
        {
            if(Configuration.isReady)
            {
                ...
                switch(_targetRenderPipeline)
                {
                    ...
                    EditorGUILayout.LabelField(@"2. On your Volume Component add the Glow Component via “Post-processing/MK/MKGlow”.", _flowTextStyle);
                    break;
